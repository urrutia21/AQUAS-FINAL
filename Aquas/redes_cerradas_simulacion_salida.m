...
% Fichero  redes_cerradas_simulacion_salida.m
...
n=zeros(1,nodos_cerradas);			%Numero de clientes que hay en cada nodo del sistema
for i=1:nodos_cerradas
    n(i)=floor((clientes_cerradas-1)*power(vector_servidores_cerradas(i),-1)/(sum(power(vector_servidores_cerradas,-1))));
end

for i=sum(n)+1:clientes_cerradas-1
    n(clientes_cerradas-1-i+1)=n(clientes_cerradas-1-i+1)+1;
end


b=-1*ones(max(vector_servidores_cerradas),nodos_cerradas);

for i=1:nodos_cerradas
    for j=1:n(i)
        if j<=vector_servidores_cerradas(i)
            b(j,i)=generar_salida(distribuciones_salida(i), parametros_salida(i,1), parametros_salida(i,2), parametros_salida(i,3));
        end
    end
end
...
while (ntot<estab_n)  
   ...
   if (n(columna_minimo_b)<vector_servidores_cerradas(columna_minimo_b))	%No quedan clientes en el sistema
   ...
   while(acumulador<numero_simulado)
      acumulador=acumulador+matriz_prob_cerradas(j,columna_minimo_b);
      j=j+1;
   end
   j=j-1;
   ...
   n(j)=n(j)+1;
   if (n(j)<=vector_servidores_cerradas(j))
...
ntot=0;
t=0;			%Cronometro
c=zeros(1,nodos_cerradas);			%Acumula tiempo * nº clientes (sistema)
d=zeros(1,nodos_cerradas);			%Acumula tiempo * nº clientes (cola)
entradas_nodo=zeros(1,nodos_cerradas);


p=zeros(clientes_cerradas,nodos_cerradas);
...
while (ntot<cli_sim_n)  
   ...
   for j=1:nodos_cerradas
      if ((j==columna_minimo_b) & (j~=nodo_transicion))
            ...
            if ((n(j)+1)>vector_servidores_cerradas(j))
                d(j)=d(j)+minimo*(n(j)+1-vector_servidores_cerradas(j));
            end            
            ...
            if ((j==nodo_transicion) & (j~=columna_minimo_b))
                ...
                c(j)=c(j)+minimo*n(j);
                if (n(j)>vector_servidores_cerradas(j))                
                    d(j)=d(j)+minimo*(n(j)-vector_servidores_cerradas(j));                
                end               
...
figure('Units', 'normalized',...
        ...
        'MenuBar', 'none', ...
        'name', 'Resolucion por simulacion: Resultados de la red de Jackson cerrada', ...
        'NumberTitle', 'off', ...
        'resize','off');
...
texto_cabecera_redes_cerradas='Resultados globales ( ';
texto_cabecera_redes_cerradas=strcat(texto_cabecera_redes_cerradas, num2str(nodos_cerradas), ' Nodos)');

text_redes_cerradas_salida_1 = uicontrol(gcf, 'Style', 'Text', ...
 	   'String', texto_cabecera_redes_cerradas, ...
   	   'Units', 'normalized', ...
...
text_redes_cerradas_salida_lqt_1 = uicontrol(gcf, 'Style', 'Text', ...
      'String', 'LqT = ', ...
   	   'Units', 'normalized', ...
	   'Position', [0.42 0.86 0.08 0.05], ...
   	   'BackgroundColor', [.6 .6 .6],...
       'FontUnits', 'normalized',...
        'FontWeight', 'bold', ...
	   'FontSize', 0.3, ...
...
for i=1:nodos_cerradas
   ...
   texto_cerradas=strcat('Nodo nº ',' ',num2str(i));

	text_redes_cerradas_salida = uicontrol(gcf, 'Style', 'Text', ...
   	    'String', texto_cerradas, ...
   	    'Units', 'normalized', ...
		'Position', [0.12 0.83-0.48*i/(nodos_cerradas+1) 0.1 0.05], ...
        'FontUnits', 'normalized',...
        'FontWeight', 'bold', ...
	    'FontSize', 0.3, ...
		'BackgroundColor', [.6 .6 .6],...
	...
	text_redes_cerradas_salida_l_1 = uicontrol(gcf, 'Style', 'Text', ...
        'String', 'L = ', ...
   	    'Units', 'normalized', ...
	    'Position', [0.25 0.83-0.48*i/(nodos_cerradas+1) 0.05 0.05], ...
    	'BackgroundColor', [.6 .6 .6],...
        'FontUnits', 'normalized',...
	    'FontSize', 0.3, ...
        'HorizontalAlignment', 'Center');   
   
   aux=num2str(l_cerradas(i));
   
  	text_redes_cerradas_salida_l_2 = uicontrol(gcf, 'Style', 'Text', ...
         'String', aux, ...
   	     'Units', 'normalized', ...
	     'Position', [0.30 0.83-0.48*i/(nodos_cerradas+1) 0.10 0.05], ...
   	     'BackgroundColor', [.6 .6 .6],...
         'FontUnits', 'normalized',...
	     'FontSize', 0.3, ...
   	     'HorizontalAlignment', 'Center');   
	...
	text_redes_cerradas_salida_lq_1 = uicontrol(gcf, 'Style', 'Text', ...
         'String', 'Lq = ', ...
   	     'Units', 'normalized', ...
	     'Position', [0.4 0.83-0.48*i/(nodos_cerradas+1) 0.05 0.05], ...
   	     'BackgroundColor', [.6 .6 .6],...
         'FontUnits', 'normalized',...
	     'FontSize', 0.3, ...
      	 'HorizontalAlignment', 'Center');   
   
    aux=num2str(lq_cerradas(i));
   
  	text_redes_cerradas_salida_lq_2 = uicontrol(gcf, 'Style', 'Text', ...
        'String', aux, ...
   	    'Units', 'normalized', ...
	    'Position', [0.45 0.83-0.48*i/(nodos_cerradas+1) 0.10 0.05], ...
      	'BackgroundColor', [.6 .6 .6],...
        'FontUnits', 'normalized',...
	    'FontSize', 0.3, ...
        'HorizontalAlignment', 'Center');   
	...
	text_redes_cerradas_salida_w_1 = uicontrol(gcf, 'Style', 'Text', ...
        'String', 'W = ', ...
   	    'Units', 'normalized', ...
	    'Position', [0.55 0.83-0.48*i/(nodos_cerradas+1) 0.05 0.05], ...
   	    'BackgroundColor', [.6 .6 .6],...
        'FontUnits', 'normalized',...
	    'FontSize', 0.3, ...
        'HorizontalAlignment', 'Center');   
     ...
     aux=num2str(w(i));
  	 ...
  	 text_redes_cerradas_salida_w_2 = uicontrol(gcf, 'Style', 'Text', ...
        'String', aux, ...
   	    'Units', 'normalized', ...
	    'Position', [0.6 0.83-0.48*i/(nodos_cerradas+1) 0.10 0.05], ...
    	'BackgroundColor', [.6 .6 .6],...
        'FontUnits', 'normalized',...
	    'FontSize', 0.3, ...
        'HorizontalAlignment', 'Center');   
	...
	text_redes_cerradas_salida_wq_1 = uicontrol(gcf, 'Style', 'Text', ...
         'String', 'Wq = ', ...
   	     'Units', 'normalized', ...
	     'Position', [0.7 0.83-0.48*i/(nodos_cerradas+1) 0.05 0.05], ...
         'BackgroundColor', [.6 .6 .6],...
         'FontUnits', 'normalized',...
	     'FontSize', 0.3, ...
         'HorizontalAlignment', 'Center');  
   ...
   aux=num2str(wq(i));
  	...
  	text_redes_cerradas_salida_wq_2 = uicontrol(gcf, 'Style', 'Text', ...
         'String', aux, ...
   	     'Units', 'normalized', ...
	     'Position', [0.75 0.83-0.48*i/(nodos_cerradas+1) 0.10 0.05], ...
   	     'BackgroundColor', [.6 .6 .6],...
         'FontUnits', 'normalized',...
	     'FontSize', 0.3, ...
         'HorizontalAlignment', 'Center');   
...
text_redes_cerradas_salida_lqt_2 = uicontrol(gcf, 'Style', 'Text', ...
      'String', num2str(aux), ...
   	  'Units', 'normalized', ...
	  'Position', [0.5 0.86 0.12 0.05], ...
   	  'BackgroundColor', [.6 .6 .6],...
      'FontUnits', 'normalized',...
	  'FontSize', 0.3, ...
   	  'HorizontalAlignment', 'Center');   
...
boton_redes_cerradas_salida_calcular = uicontrol(gcf, 'Style', 'Pushbutton',...
  ...
  'FontUnits', 'normalized',...
  'FontSize', 0.4, ...
  'Callback', 'calcular_p_cerradas_simulacion'); 
